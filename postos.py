...
partes_finais_url = [f"{ano}{m:02d}POSTOS" for m in range(1, 13)]

# Loop sobre as partes finais do URL
for parte_final_url in partes_finais_url:
    # Construa a URL completa
    url = f"https://www.bcb.gov.br/fis/info/cad/postos/{parte_final_url}.zip"
...
result_df.to_pickle(os.path.join("data", "raw", "postos.pkl"))
